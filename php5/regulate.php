...
class regulate {
	 ...
	 * @return void
	 */
	public static function rgb(&$value) {
	 ...
	 * @return void
	 */
	public static function rgb_array(&$rgb_array) {
		static::standardize_array($rgb_array, array('r', 'g', 'b'));
	 ...
	 * @return void
	 */
	public static function hsl(&$value, $offset) {
	 ...
	 * @return void
	 */
	public static function hsl_array(&$hsl_array) {
		static::standardize_array($hsl_array, array('h', 's', 'l'));
	 ...
	 * @return void
	 */
	public static function hsb_array(&$hsl_array) {
		static::standardize_array($hsl_array, array('h', 's', 'b'));
		static::hsl($hsl_array['h'], 'h');
		static::hsl($hsl_array['s'], 's');
	 ...
	 * @return void
	 */
	public static function cmyk(&$value) {
		static::percent($value);
	}
	 ...
	 * @return void
	 */
	public static function cmyk_array(&$cmyk_array) {
		static::standardize_array($cmyk_array, array('c', 'm', 'y', 'k'));
	 ...
	 * @return void
	 */
	public static function hex_int(&$value) {
	 ...
	 * @return void
	 */
	public static function _expand_shorthand(&$hex_str) {
		if (strlen($hex_str) === 3) {
			$r = $hex_str[0];
			$g = $hex_str[1];
			$b = $hex_str[2];
	 ...
	 * @return void
	 */
	public static function standardize_array(&$array, $keys = array()) {
	 ...
	 */
	public static function div($number, $divisor) {
		if ($divisor == 0) {
			return 0;
		}
